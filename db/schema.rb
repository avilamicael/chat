...
ActiveRecord::Schema[7.1].define(version: 2026_05_27_000002) do
  ...
  create_table "captain_usage_events", force: :cascade do |t|
    t.bigint "account_id", null: false
  ...
  create_table "channel_whatsapp", force: :cascade do |t|
    ...
    t.integer "max_automation_messages_per_minute"
  ...
  create_table "kanban_boards", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "is_default"], name: "index_kanban_boards_on_account_id_and_is_default"
    t.index ["account_id"], name: "index_kanban_boards_on_account_id"
  end

  create_table "kanban_card_action_executions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["card_id", "action_id", "trigger_event_id"], name: "idx_unique_card_action_execution", unique: true
    t.index ["column_id", "executed_at"], name: "idx_card_action_executions_column_executed"
  end

  create_table "kanban_card_conversations", force: :cascade do |t|
    t.bigint "kanban_card_id", null: false
    t.bigint "conversation_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["conversation_id"], name: "index_kanban_card_conversations_on_conversation_id"
    t.index ["kanban_card_id", "conversation_id"], name: "idx_unique_kanban_card_conversation", unique: true
    t.index ["kanban_card_id"], name: "index_kanban_card_conversations_on_kanban_card_id"
  end
  ...
  create_table "kanban_cards", force: :cascade do |t|
    ...
    t.index ["custom_attributes"], name: "index_kanban_cards_on_custom_attributes", using: :gin
  ...
  create_table "kanban_columns", force: :cascade do |t|
    ...
    t.jsonb "enter_actions", default: [], null: false
  ...
  add_foreign_key "kanban_cards", "teams"

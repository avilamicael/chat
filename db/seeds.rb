...
unless Rails.env.production?
  ...
  # Enable all premium features for seeded accounts
  premium_features = %w[
    disable_branding audit_logs sla captain_integration custom_roles
    csat_review_notes conversation_required_attributes advanced_assignment
    captain_integration_v2 channel_voice help_center_embedding_search
    advanced_search advanced_search_indexing saml companies
  ]
  [account, secondary_account].each { |a| a.enable_features!(*premium_features) }

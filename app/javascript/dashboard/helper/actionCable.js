...
class ActionCableConnector extends BaseActionCableConnector {
  constructor(app, pubsubToken) {
    ...
    this.events = {
      ...
      'kanban.card_moved': this.onKanbanCardMoved,
      ...
      'kanban.column_metrics_updated': this.onKanbanColumnMetricsUpdated,
    };
  }
  ...
  onKanbanCardMoved = data => {
    this.app.$store.dispatch('kanban/handleCardMoved', data);
  };

  onKanbanCardAdded = data => {
    this.app.$store.dispatch('kanban/handleCardAdded', data);
  };

  onKanbanCardRemoved = data => {
    this.app.$store.dispatch('kanban/handleCardRemoved', data);
  };
  ...
  onKanbanColumnMetricsUpdated = data => {
    this.app.$store.dispatch('kanban/handleColumnMetricsUpdated', data);
  };
}
